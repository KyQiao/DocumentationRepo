...
# I tried many way to make the iterierms successful. Finally it works but I think the code is quite 
#inefficient. The iteritems should return a generator as the book required but I return a list which 
#is iteritable but would cost a lot memory. Maybe there are other ways to do this.

#After looking up the corresponding part in the book, the right way to do this has been found.
#Using the generator or iterator is a highly recommand way. It's quick and saving memory.
#I think the low process contains dequeue or something like that.
